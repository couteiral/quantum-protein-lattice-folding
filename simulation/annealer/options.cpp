...
"    This is a software utility to numerically integrate the time-"
"    dependent Schrodinger equation to emulate quantum annealing and\n"
"    predict the annealing time.\n"
"\n"
"\n"
"      USAGE: \n"
"         ./annealer  [flags]\n"
...
Options::Options(int argc, char* argv[]) {
    ...
    */
    ...
    if (!check_cmd_option(args, "--tann")) {
        std::cout << "ERROR: Coefficient not specified, use flag --tann.\n";
        exit(1);
    }
    time = std::stod( get_cmd_option(args, "--tann").c_str() );
